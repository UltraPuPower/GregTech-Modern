...
public class Layer<S extends Screen, R extends ParentUIComponent> {
    ...
    public Instance getInstance(S screen) {
        return ((UIScreenExtension) screen).gtceu$getInstance(this);
    }
    ...
    public class Instance {
        ...
        /**
         * The UI adapter of this instance - get the {@link UIAdapter#rootComponent}
         * from this to start building your UI tree
         */
        public final UIAdapter<R> adapter;
        ...
        protected Instance(S screen) {
            this.screen = screen;
            this.adapter = UIAdapter.createWithoutScreen(0, 0, screen.width, screen.height,
                    Layer.this.rootComponentMaker);
         ...
         */
        public void alignComponentToWidget(Predicate<AbstractWidget> locator, AnchorSide anchor, float justification,
        ...
        public void alignComponentToHandledScreenCoordinates(UIComponent component, int x, int y) {
            if (!(this.screen instanceof AbstractContainerScreen<?> handledScreen)) {
                throw new IllegalStateException(
                        "Handled screen coordinates only exist on screens which extend HandledScreen<?>");
            }
